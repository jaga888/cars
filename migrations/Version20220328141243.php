...
final class Version20220328141243 extends AbstractMigration
{
    ...
    {
        $this->addSql('create domain CLOB as text');
        ...
        $this->addSql('CREATE TABLE messenger_messages (id SERIAL PRIMARY KEY, body CLOB NOT NULL, headers CLOB NOT NULL, queue_name VARCHAR(255) NOT NULL, created_at TIMESTAMP NOT NULL, available_at TIMESTAMP NOT NULL, delivered_at TIMESTAMP DEFAULT NULL)');
